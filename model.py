...
class Unet(nn.Module):
    def __init__(self):
        ...
        self.classifier3 = nn.Sequential(nn.Linear(65536, 512),nn.ReLU())
        self.classifier = nn.Linear(512 * 4, 3)
    ...
    def forward(self, x):
        ...
        out3_1 = self.classifier1(self.flatten(out1[:, 1, :, :]))
        out4_1 = self.classifier1(self.flatten(out1[:, 2, :, :]))
        inp_1 = torch.concat([out1_1, out2_1, out3_1, out4_1], dim=1)
